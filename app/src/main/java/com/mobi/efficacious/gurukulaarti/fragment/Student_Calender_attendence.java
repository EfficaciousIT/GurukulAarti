...
import com.mobi.efficacious.gurukulaarti.adapters.StandardAdapter;
import com.mobi.efficacious.gurukulaarti.dialogbox.Image_zoom_dialog_student;
            ...
            if ((taskListDataList != null && !taskListDataList.isEmpty())) {
                ...
                for (int i = 0; i < taskListDataList.size(); i++) {
                    ...
                    if (taskListDataList.get(i).getStatus().contentEquals("Present")) {
                        ...
                        bgToday = new ColorDrawable(Color.LTGRAY);
                    }
